...
import { Server, LayoutDashboard, LogOut, PanelLeft, Camera, Plus } from "lucide-react";
          ...
          <SidebarContent className="gap-0 py-2">
            ...
            <div className="px-3 mt-4">
              ...
              >
                ...
                <span className="group-data-[collapsible=icon]:hidden">New VM</span>
              </Button>
            </div>
          </SidebarContent>
